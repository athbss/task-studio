...
// Mock issues data has been removed as the app now uses real Taskmaster data
// Only keeping the Issue interface and utility functions that are still in use
